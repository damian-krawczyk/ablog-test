...
# ablog-test build configuration file, created by
# `ablog start` on Mon Nov 23 09:26:33 2020.
#
...
blog_authors = {
    'Damian Krawczyk': ('Damian Krawczyk', None),
}
...
project = u'ablog-test'
copyright = u'2020, Damian Krawczyk'
author = u'Damian Krawczyk'
